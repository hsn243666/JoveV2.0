...
maxname[2] = user.print_name
	...
	maxuser[1] = 'Did not have'
	else
	maxuser[1] = '@'..maxuser[1]
	end
	if not maxuser[2] or maxuser[2] == '' then
	maxuser[2] = 'Did not have'
	else
	maxuser[2] = '@'..maxuser[2]
	end
	if not maxuser[3] or maxuser[3] == '' then
	maxuser[3] = 'Did not have'
	else
	maxuser[3] = '@'..maxuser[3]
end
local text = '♨️Today active User\n1⃣ '..maxname[1]..'〖'..maxuser[1]..'〗\n\n📨Messages sent: '..maxtex[1] + maxph[1] + maxst[1] + maxoth[1]..'\n\n👾Stickers: '..maxst[1]..'\n\n📷Photos: '..maxph[1]..'\n\n📃Texts: '..maxtex[1]..'\n\n📦Others: '..maxoth[1]
if maxid[2] then
	if not maxid[3] then
text = text..'\n\n 2⃣ '..maxname[2]..' 〖'..maxuser[2]..'〗\n\n📨Messages sent: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n\n👾Stickers: '..maxst[2]..'\n\n📷Photos: '..maxph[2]..'\n\n📃Texts: '..maxtex[2]..'\n\n📦Others: '..maxoth[2]
else
text = text..'\n\n 2⃣ '..maxname[2]..' 〖'..maxuser[2]..'〗\n\n📨Messages sent: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n\n👾Stickers: '..maxst[2]..'\n\n📷Photos: '..maxph[2]..'\n\n📃Texts: '..maxtex[2]..'\n\n📦Others: '..maxoth[2]..'\n\n 3⃣ '..maxname[3]..' 〖'..maxuser[3]..'〗\n\n📨Messages sent: '..maxtex[3] + maxph[3] + maxst[3] + maxoth[3]..'\n\n👾Stickers: '..maxst[3]..'\n\n📷Photos: '..maxph[3]..'\n\n📃Texts: '..maxtex[3]..'\n\n📦Others: '..maxoth[3]
end
end
